class gerrit::build {
  ...
  case $gerrit::params::database_type {
    'postgresql': {
      $initialization_command = "/usr/bin/sudo -u ${gerrit::params::user} /usr/bin/java -jar ${gerrit::params::stage_dir}/${gerrit::params::war_file} init --batch -d ${gerrit::params::home} --no-auto-start"
    }
    default: {
      $initialization_command = "/usr/bin/sudo -u ${gerrit::params::user} /usr/bin/java -jar ${gerrit::params::stage_dir}/${gerrit::params::war_file} init -d ${gerrit::params::home} --batch --no-auto-start"
    }
  }
